...
session = fastf1.get_session(2023, 'Bahrain Grand Prix', 'FP2')
session.load()
...
mer_color = fastf1.plotting.team_color('AMR')

fig, ax = plt.subplots()
ax.plot(ver_tel['Distance'], ver_tel['Speed'], color=rbr_color, label='VER')
ax.plot(ham_tel['Distance'], ham_tel['Speed'], color=mer_color, label='ALO')
